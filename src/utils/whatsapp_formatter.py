...
TRANSLATIONS = {
    "fr": {
        ...
        "menu_items": [
            {"title": "🏗️ Voir mes chantiers", "id": "view_sites_fr"},
            {"title": "✅ Consulter mes taches", "id": "view_tasks_fr"},
            {"title": "📄 Acceder aux documents", "id": "view_documents_fr"},
            {"title": "🚨 Signaler un incident", "id": "report_incident_fr"},
            {"title": "📊 Progression", "id": "update_progress_fr"},
            {"title": "💬 Contacter equipe", "id": "talk_team_fr"},
        ],
    ...
    "en": {
        ...
        "menu_items": [
            {"title": "🏗️ View my sites", "id": "view_sites_en"},
            {"title": "✅ Check my tasks", "id": "view_tasks_en"},
            {"title": "📄 Access documents", "id": "view_documents_en"},
            {"title": "🚨 Report incident", "id": "report_incident_en"},
            {"title": "📊 Update progress", "id": "update_progress_en"},
            {"title": "💬 Talk to team", "id": "talk_team_en"},
        ],
    ...
    "es": {
        ...
        "menu_items": [
            {"title": "🏗️ Ver mis obras", "id": "view_sites_es"},
            {"title": "✅ Ver mis tareas", "id": "view_tasks_es"},
            {"title": "📄 Acceder documentos", "id": "view_documents_es"},
            {"title": "🚨 Reportar incidente", "id": "report_incident_es"},
            {"title": "📊 Actualizar progreso", "id": "update_progress_es"},
            {"title": "💬 Hablar con equipo", "id": "talk_team_es"},
        ],
    ...
    "pt": {
        ...
        "menu_items": [
            {"title": "🏗️ Ver minhas obras", "id": "view_sites_pt"},
            {"title": "✅ Ver minhas tarefas", "id": "view_tasks_pt"},
            {"title": "📄 Acessar documentos", "id": "view_documents_pt"},
            {"title": "🚨 Relatar incidente", "id": "report_incident_pt"},
            {"title": "📊 Atualizar progresso", "id": "update_progress_pt"},
            {"title": "💬 Falar com equipe", "id": "talk_team_pt"},
        ],
    ...
    "de": {
        ...
        "menu_items": [
            {"title": "🏗️ Meine Baustellen", "id": "view_sites_de"},
            {"title": "✅ Meine Aufgaben", "id": "view_tasks_de"},
            {"title": "📄 Dokumente", "id": "view_documents_de"},
            {"title": "🚨 Vorfall melden", "id": "report_incident_de"},
            {"title": "📊 Fortschritt", "id": "update_progress_de"},
            {"title": "💬 Team kontaktieren", "id": "talk_team_de"},
        ],
    ...
    "it": {
        ...
        "menu_items": [
            {"title": "🏗️ Vedi cantieri", "id": "view_sites_it"},
            {"title": "✅ Vedi compiti", "id": "view_tasks_it"},
            {"title": "📄 Accedi documenti", "id": "view_documents_it"},
            {"title": "🚨 Segnala incidente", "id": "report_incident_it"},
            {"title": "📊 Aggiorna progresso", "id": "update_progress_it"},
            {"title": "💬 Parla con team", "id": "talk_team_it"},
        ],
    ...
    "ro": {
        ...
        "menu_items": [
            {"title": "🏗️ Vezi santierele", "id": "view_sites_ro"},
            {"title": "✅ Vezi sarcinile", "id": "view_tasks_ro"},
            {"title": "📄 Acceseaza documente", "id": "view_documents_ro"},
            {"title": "🚨 Raporteaza incident", "id": "report_incident_ro"},
            {"title": "📊 Actualizeaza progres", "id": "update_progress_ro"},
            {"title": "💬 Vorbeste cu echipa", "id": "talk_team_ro"},
        ],
    ...
    "pl": {
        ...
        "menu_items": [
            {"title": "🏗️ Zobacz place budowy", "id": "view_sites_pl"},
            {"title": "✅ Zobacz zadania", "id": "view_tasks_pl"},
            {"title": "📄 Dostep do dokumentow", "id": "view_documents_pl"},
            {"title": "🚨 Zglosz incydent", "id": "report_incident_pl"},
            {"title": "📊 Aktualizuj postep", "id": "update_progress_pl"},
            {"title": "💬 Porozmawiaj", "id": "talk_team_pl"},
        ],
    ...
    "ar": {
        ...
        "menu_items": [
            {"title": "🏗️ عرض مواقعي", "id": "view_sites_ar"},
            {"title": "✅ عرض مهامي", "id": "view_tasks_ar"},
            {"title": "📄 الوثائق", "id": "view_documents_ar"},
            {"title": "🚨 الإبلاغ عن حادث", "id": "report_incident_ar"},
            {"title": "📊 تحديث التقدم", "id": "update_progress_ar"},
            {"title": "💬 التحدث مع الفريق", "id": "talk_team_ar"},
        ],
