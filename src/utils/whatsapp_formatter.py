...
TRANSLATIONS = {
    "fr": {
        ...
        "menu_items": [
            {"title": "Voir mes chantiers 🏗️", "id": "view_sites_fr", "description": "Projets actifs"},
    ...
    "en": {
        ...
        "menu_items": [
            {"title": "View my sites 🏗️", "id": "view_sites_en", "description": "Active projects"},
    ...
    "es": {
        ...
        "menu_items": [
            {"title": "Ver mis obras 🏗️", "id": "view_sites_es", "description": "Proyectos activos"},
    ...
    "pt": {
        ...
        "menu_items": [
            {"title": "Ver minhas obras 🏗️", "id": "view_sites_pt", "description": "Projetos ativos"},
    ...
    "de": {
        ...
        "menu_items": [
            {"title": "Meine Baustellen 🏗️", "id": "view_sites_de", "description": "Aktive Projekte"},
    ...
    "it": {
        ...
        "menu_items": [
            {"title": "Vedi cantieri 🏗️", "id": "view_sites_it", "description": "Progetti attivi"},
    ...
    "ro": {
        ...
        "menu_items": [
            {"title": "Vezi santierele 🏗️", "id": "view_sites_ro", "description": "Proiecte active"},
    ...
    "pl": {
        ...
        "menu_items": [
            {"title": "Zobacz place budowy 🏗️", "id": "view_sites_pl", "description": "Aktywne projekty"},
    ...
    "ar": {
        ...
        "menu_items": [
            {"title": "عرض مواقعي 🏗️", "id": "view_sites_ar", "description": "المشاريع النشطة"},
